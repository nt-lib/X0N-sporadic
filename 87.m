...
// These are files from the paper N. Adžaga, T. Keller, P. Michaud-Jacobs, F. Najman, E. Ozman, B. Vukorepa, Computing quadratic points on modular curves X_0(N), Math. Comp. 93 (2024), 1371-1397. We use some auxilliary code, e.g. for computing the j-map, from there.
